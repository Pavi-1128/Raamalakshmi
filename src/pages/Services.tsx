...
const Services = () => {
  ...
  const translationServices = [
    ...
    { 
      title: 'Book Translation (fiction, biographies, devotional, management studies, astrology)',
      description: null
    },
    { 
      title: 'Simultaneous Translation (expert-level for live meetings)',
      description: 'Real-time translation without breaks, often done via an online mirror where participants don’t see the translator.'
    },
    { 
      title: 'Consecutive Translation',
      description: 'Similar approach but with brief pauses, allowing speakers to stop so clients can take notes.'
    },
    { 
      title: 'Transcription & Oral Transcription',
      description: null
    },
    { 
      title: 'Report Writing & Content Analysis',
      description: null
    },
  ];
  ...
  const otherServices = [
    ...
    'Case Study Writing',
    'Content Editing & Content Creation [Tamil & Telgu]',
    'Family Counseling and Community Social Work Counseling in other services'
  ];
                  ...
                  <div key={index} className="space-y-3">
                    ...
                    {service.description && (
                      <div className="ml-10 mt-2">
                        <p className="text-gray-600 text-sm leading-relaxed bg-terracotta-50 p-3 rounded-lg border-l-2 border-terracotta-200">
                          {service.description}
                        </p>
                      </div>
                    )}
            ...
            <div className="p-8">
              ...
              <div className="mt-8 space-y-4">
                ...
                <div className="bg-blue-50 p-6 rounded-lg">
                  <h4 className="font-semibold text-gray-800 mb-2">📲 WhatsApp-based Classes</h4>
                  <p className="text-gray-700">
                    Learn Translation Studies and Market Research Entry Course through WhatsApp with flexible live and recorded classes..
                  </p>
                </div>
              </div>
            </div>
